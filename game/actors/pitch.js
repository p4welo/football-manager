Pitch = function (game) {
    ...
    this.hostGoal = new Goal(this.game, this.playingArea.bounds.x, this.playingArea.bounds.height / 2, true);
    this.guestGoal = new Goal(this.game, this.playingArea.bounds.width, this.playingArea.bounds.height / 2, false);
